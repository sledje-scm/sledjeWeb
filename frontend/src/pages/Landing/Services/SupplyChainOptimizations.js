...
export default function SupplyChainOptimizations() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-blue-100 text-gray-900">
      ...
      <section className="py-16 bg-gradient-to-r from-blue-800 to-blue-600 text-white text-center">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-3xl font-bold">Streamline Your Supply Chain</h2>
          <p className="mt-4 text-lg">
            Achieve operational excellence with our supply chain solutions.
          </p>
          <motion.button
