...
export default function BillingCreditManagement() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-blue-100 text-gray-900">
      ...
      <section className="relative text-center py-20 px-6 bg-gradient-to-r from-blue-800 to-blue-600 text-white">
        <div className="max-w-4xl mx-auto">
          ...
          >
            Simplify your billing processes and manage credit efficiently.
          </motion.p>
        </div>
      </section>
      ...
      <section className="py-16 bg-gradient-to-r from-blue-800 to-blue-600 text-white text-center">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-3xl font-bold">Streamline Your Billing Today</h2>
          <p className="mt-4 text-lg">
            Experience hassle-free billing and credit management with our solutions.
          </p>
          <motion.button
